...
con.close();
		...
		dp.setBounds(460,40,300,25);
		P2.add(dp);	
		
		L4=new JLabel("Bicycle Id");
		L4.setFont(f1);
		add(L4);
		L4.setBounds(150,90,250,25);
		...
		t2.setFont(f1);
		add(t2);
		t2.setBounds(460,90,300,25);
		P2.add(t2);	

		L5=new JLabel("model");
		L5.setFont(f1);
		add(L5);
		L5.setBounds(150,132,250,25);
		...
		t3.setFont(f1);
		add(t3);
		t3.setBounds(460,132,300,25);
		P2.add(t3);	

		L6=new JLabel("Type");
		L6.setFont(f1);
		add(L6);
		L6.setBounds(150,178,250,25);
		...
		t4.setFont(f1);
		add(t4);
		t4.setBounds(460,233,300,100);
		P2.add(t4);	

		L8=new JLabel("Quantity");
		L8.setFont(f1);
		add(L8);
		L8.setBounds(150,363,250,25);
		...
		t5.setFont(f1);
		add(t5);
		t5.setBounds(460,363,300,25);
		P2.add(t5);	

		L8=new JLabel("Rate");
		L8.setFont(f1);
		add(L8);
		L8.setBounds(150,405,250,25);
				L8.setForeground(Color.white);
		P2.add(L8);
	...
	//save button b2
		...
		con=DriverManager.getConnection("jdbc:mysql://localhost:3306/green_Bicycle_DB","root","root");
		st=con.createStatement();
		q="insert into product values("+Integer.parseInt(pid)+",'" + name +"','"+type+"','"+description+"','"+qty+"','"+rate+"','"+ sid +"')";
		st.executeUpdate(q);
		con.close();
