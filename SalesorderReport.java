...
public class SalesorderReport extends JFrame implements ActionListener,ItemListener{
	...
	public SalesorderReport()
     { 
        ...
        // add(p3);
         ...
         l6=new JLabel("Issue Oder Report");
         l6.setFont(f3);
   ...
   public void actionPerformed(ActionEvent ae)
	   ...
	   String s; 
		...
		if(ae.getSource()==b1)
		{
			...
			try {
    			...
    			String sql="select * from tbl_Issueorder";
    		    rs=st.executeQuery(sql);
    		    	final String[] cols={"Issue Id","Issue Date","Return Date","IssueTime ","No of hours","type","rate","Total",};
	...
	public static void main(String[] args) {
		...
		SalesorderReport ob=new SalesorderReport();
