...
public class CustomerReport extends JFrame implements ActionListener,ItemListener{
   ...
   public void actionPerformed(ActionEvent ae)
		...
		if(ae.getSource()==b1)
		{
			...
			try {
    		    ...
    		    rs=st.executeQuery(sql);
    		    	...
    		    	final Object rows[][]=new Object[30][8];
	...
	public static void main(String[] args) {
		...
		CustomerReport ob=new CustomerReport();
